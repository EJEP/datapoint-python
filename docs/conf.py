...
htmlhelp_basename = 'datapoint-python-doc'
...
man_pages = [
    (master_doc, 'datapoint-python', 'datapoint-python Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'datapoint-python', 'datapoint-python Documentation',
     author, 'datapoint-python', 'One line description of project.',
     'Miscellaneous'),
]
