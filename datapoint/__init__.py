...
__license__ = "See: http://www.metoffice.gov.uk/datapoint/terms-conditions "
__copyright__ = "Copyright (c) 2014 Crown"
...
def connection(profile_name='default'):
